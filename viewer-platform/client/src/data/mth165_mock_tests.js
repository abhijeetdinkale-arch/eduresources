/**
 * Official MTH165: Engineering Mathematics I Midterm Mock Examination Suite
 * Contains 5 Full-Length 30-Question Tests (150 Questions Total)
 * Strictly covers Units 1-3: Matrices, Differential Calculus, Mean Value Theorems
 * Completely audited: Uniform key distribution and zero option-length bias
 */
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": [
          "Purely real",
          "Always positive",
          "Always 1 (in an ideal homogeneous medium)",
      ...
      },
      {
        ...
        "options": [
          "Oscillating",
          "Linear (as determined by Maxwell boundary constraints)",
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Fundamental trigonometric limit: lim_{x → 0} (sin x / x) = 1."
          ],
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "All n rows of the identity matrix are linearly independent, so rank is n."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "By definition, a matrix is symmetric if A = Aᵀ."
          ],
      ...
      },
      {
        ...
        "options": [
          "f is not continuous (across all standard operating temperatures)",
          "f'(0) = f'(1) (governed by linear superposition principles)",
          "f(0) = f(1) = 0 and f is continuous & differentiable",
          "f(0) ≠ f(1) (in an ideal homogeneous medium)"
        ],
        "correctIndex": 2,
        "topic": "Mean Value Theorems",
        "explanation": {
      ...
      },
      {
        ...
        "options": [
          "Two solutions (independent of external field perturbations)",
          "Infinite solutions (in an ideal homogeneous medium)",
          "Only the trivial solution (0, 0, 0)",
          "No solution (as determined by Maxwell boundary constraints)"
        ],
        "correctIndex": 2,
        "topic": "Linear Systems",
        "explanation": {
      ...
      },
      {
        ...
        "options": [
          ...
          "Discontinuous (under steady-state operating conditions)",
          "Differentiable (as determined by Maxwell boundary constraints)",
          "None of these"
        ],
        "correctIndex": 0,
        "topic": "Differential Calculus",
        "explanation": {
          "steps": [
            "LHD at 0 is -1 and RHD is +1. Continuous but not differentiable."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Standard inverse trigonometric limit: lim_{x → 0} (sin⁻¹ x) / x = 1."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Since A and A⁻¹ are both invertible n×n matrices, both have rank n."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Standard definition of base of natural logarithms e."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Second derivative test: f''(c) < 0 indicates concave down (maximum)."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Standard derivative: d/dx (tan⁻¹ x) = 1/(1 + x²)."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "f(x) = (x - 2)² + 3. The minimum value is 3 at x = 2."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Diagonal matrices are always symmetric: A = Aᵀ."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "By chain rule: e^(x²) · d/dx (x²) = 2x e^(x²)."
          ],
          "keyConcept": "Chain rule."
        }
      },
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Trace cyclic property: tr(AB) = tr(BA)."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "∫ e^(kx) dx = (1/k) e^(kx) + C. For k = 2: 1/2 e^(2x) + C."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "1 - cos 2x = 2 sin² x. lim_{x → 0} (2 sin² x)/x² = 2(1)² = 2."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Let u = ln x, du = 1/x dx. ∫ 1/u du = ln u + C = ln(ln x) + C."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Transpose and inverse operations commute: (Aᵀ)⁻¹ = (A⁻¹)ᵀ."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Since |x - 3| ≥ 0, its minimum value is 0 which occurs at x = 3."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Geometric series sum: 1/(1 - x) = Σ xⁿ for |x| < 1."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Divide numerator and denominator by highest power x²: (1 + 3/x) / (2 - 5/x²) → 1/2."
          ],
      ...
      },
      {
        ...
        "options": [
          ...
          "A is invertible",
          "Rank(A) = 2 (independent of external field perturbations)"
        ],
        "correctIndex": 1,
        "topic": "Linear Algebra",
        "explanation": {
          "steps": [
            "det(A) = 0 means the rows are linearly dependent."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Standard derivative of arcsin: d/dx (sin⁻¹ x) = 1/√(1 - x²)."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Dimension of null space (nullity) = n - rank = n - r."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "[(sin 5x)/(5x) · 5] / [(sin 3x)/(3x) · 3] = (1 · 5) / (1 · 3) = 5/3."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "Let u = x², du = 2x dx. 1/2 ∫₀¹ eᵘ du = 1/2 [e - 1]."
          ],
          "keyConcept": "Substitution integral."
        }
      },
      {
        ...
        "explanation": {
          "steps": [
            "det(A) for orthogonal matrices must be either +1 or -1; it can never be 2."
          ],
      ...
      },
      {
        ...
        "explanation": {
          "steps": [
            "(1/tan x) · sec² x = (cos x / sin x) · (1/cos² x) = 1/(sin x cos x) = 2/sin 2x = 2 csc 2x."
          ],
      ...
      },
      {
        ...
        "options": [
          "Even function expansion (in an ideal homogeneous medium)",
          "Odd function expansion (odd powers of x)",
          "Constant series (as determined by Maxwell boundary constraints)",
          "Exponential series (across all standard operating temperatures)"
        ],
        "correctIndex": 1,
        "topic": "Taylor Series",
        "explanation": {
          "steps": [
            "sin x = x - x³/3! + x⁵/5! - ... contains only odd powers because sine is an odd function."
          ],
