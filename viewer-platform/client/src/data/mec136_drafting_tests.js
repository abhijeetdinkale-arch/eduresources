/**
 * Official MEC136 / MEC103: Engineering Graphics and CAD Midterm Examination Suite
 * Non-MCQ Subjective Drafting & Blueprint Examination Suite
 * Modelled directly on authentic University Midterm Question Papers (Codes: MEC136, Paper Code: A)
 * Focuses strictly on Units 1-3:
 *   Unit 1: Lettering, Dimensioning & Construction of Scales (Plain & Diagonal Scales)
 *   Unit 2: Projections of Points & Lines (1st & 3rd Angle Projections, Traces, True Lengths)
 *   Unit 3: Orthographic Projections from 3D Isometric Components (Multi-View Drafting & Sectioning)
 * Time Allowed: 90 Minutes (01:30 hrs) • Max Marks: 40 Marks
 * Structure:
 *   Part-A: 5 Compulsory Short Conceptual & Technical Questions (2 Marks each = 10 Marks)
 *   Part-B: 3 Major Blueprint Drafting & Construction Problems (10 Marks each = 30 Marks)
 */
...
export const MEC136_DRAFTING_TESTS = [
  {
    ...
    topics: ['Diagonal Scales', 'Projections of Lines', 'Orthographic Multi-View', 'First & Third Angle', 'Lettering'],
      ...
      problems: [
        {
          ...
          scoringRubric: [
            { criterion: 'Calculation of LOS (10 cm) & Formula', marks: 2 },
            { criterion: 'Equal division of main scale (5 parts) & decimetres (10 parts)', marks: 3 },
            { criterion: 'Accurate construction of diagonal lines (10 parts) & parallelism', marks: 3 },
            { criterion: 'Accurate marking of 4.75 m with standard dimensioning & lettering', marks: 2 }
          ]
        },
        {
          id: 'p3',
          ...
          scoringRubric: [
            { criterion: 'Reference line XY and correct projection of point A', marks: 2 },
            { criterion: 'Front view a\'b\' drawn at 45° true length (60 mm)', marks: 3 },
            { criterion: 'Top view ab drawn parallel to XY with correct apparent length (42.4 mm)', marks: 3 },
            { criterion: 'Correct construction and labeling of Horizontal Trace (HT)', marks: 2 }
          ]
        },
        {
          id: 'p4',
          ...
          scoringRubric: [
            { criterion: 'Accurate Front View (FV) with correct stepped profile', marks: 3 },
            { criterion: 'Accurate Top View (TV) with correct boundary dividing line', marks: 3 },
            { criterion: 'Accurate Side View (SV) projected using 45° miter / alignment', marks: 2 },
            { criterion: 'Standard ISO dimensioning, projection alignment, and line quality', marks: 2 }
          ]
        }
      ]
    },
